...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(gr_axis_width),Subplot{GRBackend},Axis})
    ...
    Base.precompile(Tuple{typeof(update_clims),Float64,Float64,Vector{Float64},typeof(ignorenan_extrema)})
    ...
    isdefined(Plots, Symbol("#324#360")) && Base.precompile(Tuple{getfield(Plots, Symbol("#324#360"))})

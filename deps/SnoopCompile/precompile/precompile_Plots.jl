...
function _precompile_()
    ...
    isdefined(Plots, Symbol("#add_major_or_minor_segments#120")) && Base.precompile(Tuple{getfield(Plots, Symbol("#add_major_or_minor_segments#120")),Vector{Int64},Bool,Segments{Tuple{Float64, Float64}},Float64,Bool})

...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(mesh3d)),Any,typeof(mesh3d),Any,Vararg{Any, N} where N})
    ...
    Base.precompile(Tuple{typeof(make_steps),Base.OneTo{Int64},Symbol,Bool})

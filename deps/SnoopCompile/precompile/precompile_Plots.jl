...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline.preprocess_attributes!),Plot{GRBackend},Dict{Symbol, Any}})
    ...
    Base.precompile(Tuple{typeof(get_series_color),Symbol,Subplot{PlotlyBackend},Int64,Symbol})

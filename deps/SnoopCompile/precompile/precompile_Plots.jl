...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(process_clims),Symbol})
    ...
    isdefined(Plots, Symbol("#173#174")) && Base.precompile(Tuple{getfield(Plots, Symbol("#173#174")),Tuple{Int64, Symbol}})

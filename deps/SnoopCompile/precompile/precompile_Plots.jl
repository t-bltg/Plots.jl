...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(_preprocess_barlike),DefaultsDict,Vector{Int64},Vector{Float64}})
    ...
    Base.precompile(Tuple{typeof(gr_draw_segments),Series,StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}},Vector{Float64},Nothing,Tuple{Float64, Float64}})
    ...
    Base.precompile(Tuple{typeof(left),BoundingBox{Tuple{Length{:w, Float64}, Length{:h, Float64}}, Tuple{Length{:w, Float64}, Length{:h, Float64}}}})

...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(*),AbsoluteLength,Length{:pct, Float64}})
    ...
    Base.precompile(Tuple{typeof(calc_num_subplots),EmptyLayout})
    ...
    Base.precompile(Tuple{typeof(gr_draw_markers),Series,Vector{Int64},Vector{Int64},Tuple{Float64, Float64}})
    ...
    Base.precompile(Tuple{typeof(wraptuple),Tuple{Int64, Matrix{Symbol}}})

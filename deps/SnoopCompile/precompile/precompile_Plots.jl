...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(gr_draw_border),Subplot{GRBackend},Axis,Segments{Tuple{Float64, Float64}}})
    ...
    isdefined(Plots, Symbol("#9#13")) && Base.precompile(Tuple{getfield(Plots, Symbol("#9#13")),UnitRange{Int64}})

...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(convertLegendValue),Bool})
    ...
    Base.precompile(Tuple{typeof(gr_draw_ticks),Subplot{GRBackend},Axis,Segments{Tuple{Float64, Float64, Float64}},Function})
    ...
    Base.precompile(Tuple{typeof(iter_segments),Base.OneTo{Int64},Vararg{Any, N} where N})

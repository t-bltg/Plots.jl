...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(processGridArg!),Dict{Symbol, Any},Int64,Symbol})
    ...
    isdefined(Plots, Symbol("#181#182")) && Base.precompile(Tuple{getfield(Plots, Symbol("#181#182")),Tuple{Int64, Expr}})
